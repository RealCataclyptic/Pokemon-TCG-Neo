...
; return NUM_CARDS in e, minus 1 if Entei2 or ShadowLugia has not been collected (minus 2 if neither)
GetCardAlbumProgress::
	...
	jr z, .next1
	dec e ; if ENTEI2 not owned
.next1
	ld l, SHADOW_LUGIA
	bit CARD_NOT_OWNED_F, [hl]
	jr z, .next2
	dec e ; if Shadow Lugia not owned
.next2
