...
PointerTable_AttackAnimation:
	...
	dw AttackAnimation_Web	               ; ATK_ANIM_WEB ;X
	dw AttackAnimation_PkmnPwr2            ; ATK_ANIM_PKMN_POWER_2 ;X
	dw AttackAnimation_DriveOff            ; ATK_ANIM_DRIVE_OFF ;
	dw AttackAnimation_GooHit              ; ATK_ANIM_GOO ;X
	dw AttackAnimation_Earthquake          ; ATK_ANIM_EARTHQUAKE ;X
	...
	dw AttackAnimation_Gas                 ; ATK_ANIM_GAS ;X
...
AttackAnimation_BoyfriendsProtect:
	anim_player         DUEL_ANIM_GLOW
...
AttackAnimation_DevolutionBeam:
	...
	anim_play_area      DUEL_ANIM_WATER_JETS
