...
CFNoTrainersorCFNtext:
	text "If heads, Confusion! If tails,"
	line "No trainers next opponent's turn!"
	done
...
UnableToUsePkmnPowerDueToToxicGasText:
	text "All Pokémon Powers have stopped"
	line "working due to Scare."
	done
...
CrossAttackEffectText: ; Unused
	text "Delibird's Present Effect!"
	done
...
NoRetreatCFCheckText: ; Unused
	text "If Heads, unable to"
	line "Retreat during next turn!"
	done

CantRetreatText: ; Unused
	text "Unable to Retreat due"
	line "to a card effect."
	done

UnusedText008e: ; Unused
	text "If heads, Confusion!"
	line "If tails, Sleep!"
	done

UnusedText008f: ; Unused
	text "If heads, +10 damage"
	line "And can't retreat!"
	done
...
RandomStatusText: 
	text "If 1 is heads, inflict"
	line "a random status!"
	done
...
VenomPowderCheckText:
	text "Success check! If Heads,"
	line "opponent is Poisoned & Paralyzed."
	done
...
FlipUntilFailAppears10DamageForEachHeadsText:
	text "Flip until Tails appears. Discard 1"
	line "card from the deck for each heads!"
	done
...
CardCheckIfHeads8CardsIfTails1CardText:
	text "Card check!"
	line "If Heads, 9 cards! If Tails, 1 card!"
	done
