...
.ows_dcc3
	...
	jump_if_event_equal EVENT_MAN1_GIFT_SEQUENCE_STATE, 2, .ows_dcd7
	quit_script_fully

.ows_dcd7
	print_npc_text Man1PlayerReceivePikachuAltLv16Text
	give_card KINGDRA_S
	show_card_received_screen KINGDRA_S
...
Script_BeatImakuni:
	...
	jump_if_event_equal EVENT_IMAKUNI_WIN_COUNT, 2, .three_wins
	jump_if_event_equal EVENT_IMAKUNI_WIN_COUNT, 4, .six_wins
.give_boosters
