...
LegendaryMoltresDeck: ; = Legendary Entei. Used by Grand Master Courtney.
	deck_list_start
...
LegendaryZapdosDeck: ; = Legendary Raikou. Used by Grand Master Steve.
	deck_list_start
	card_item LIGHTNING_ENERGY, 12
...
LegendaryArticunoDeck: ; = Legendary Suicune. Used by Grand Master Jack.
	deck_list_start
...
LegendaryDragoniteDeck: ; = Legendary Lugia. Used by Grand Master Rod.
	deck_list_start
