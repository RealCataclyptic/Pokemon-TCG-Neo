AcidCheckText:
	text "If Heads, opponent is "
	line "Asleep & Confused."
	done

TransparencyCheckText:
	text "Baby Power check! If heads,"
...
UnableToUseTrainerDueToHeadacheText:
	...
	line "due to an opponent's effect."
	done
...
NoDamageOrEffectDueToTransparencyText:
	text "No damage or effect on next Attack"
	line "due to the effects of Baby Power."
	done
...
ProcedureForEnergyTransferText:
	...
	line ""
	line "1. Choose the Pokémon to move the"
...
ProcedureForStrangeBehaviorText:
	...
	line "   Togetic will be Knocked Out."
	done
...
UnusedText014f: ; Unused
	text "Choose 5 Energy cards in the Discard"
	line "Pile to attach to this Pokémon."
	done
...
UnusedText0154: ; Unused
	text "Choose 1 Energy card in the Discard"
	line "Pile to attach to this Pokémon."
	done
