...
DiscardAllEnergyEffect:
	farcall DiscardAllEnergyEffect2
	ret
...
DT_PlayerSelect:
	...
	jp nc, Lure_PlayerSelectEffect
	ld a, $ff ; no pokes on bench
	ldh [hTemp_ffa0], a
	ret
...
DT_SwitchEffect:
	...
	call GetNonTurnDuelistVariable
	or a
	ret z ; DFP was knocked out, no switch.
	ldh a, [hTemp_ffa0]
	cp $ff
	ret z
	jp Lure_SwitchEffect

DT_AIEffect:
	call CheckOpponentBenchIsNotEmpty
	jp nc, Lure_AISelectEffect
	ld a, $ff ; no pokes on bench
	ldh [hTemp_ffa0], a
	ret
...
.heads
	...
	call DrawWideTextBox_WaitForInput
	call .DisplayOppHand ; makes it easier to do this effect one-sided
