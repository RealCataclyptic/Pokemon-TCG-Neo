...
DragonTornadoEffectCommands:		; Switches the opponent's active after doing damage, but you pick.
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, DT_SwitchEffect
	dbw EFFECTCMDTYPE_REQUIRE_SELECTION, DT_PlayerSelect
	dbw EFFECTCMDTYPE_AI_SELECTION, DT_AIEffect
...
MayDo20Plus20EffectCommands:		; May do 20 more on coinflip. Specific to an attack that does 10+20 (legacy).
...
DiscardAllFireEnergyEffectCommands:		; Discards all fire energy upon use, then does +20 for each fire discarded.
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, ThunderboltEffect
	db  $00

DiscardAllEnergyEffectCommands:   ; Discards all energy before use
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, DiscardAllEnergyEffect
	db  $00
