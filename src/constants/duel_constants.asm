...
DEF DUELVARS_ARENA_CARD_ATTACHED_CRYSTAL_SHARD     EQUS "LOW(wPlayerArenaCardAttachedDefender)"   ; da
DEF DUELVARS_BENCH1_CARD_ATTACHED_CRYSTAL_SHARD    EQUS "LOW(wPlayerBench1CardAttachedDefender)"  ; db
DEF DUELVARS_BENCH2_CARD_ATTACHED_CRYSTAL_SHARD    EQUS "LOW(wPlayerBench2CardAttachedDefender)"  ; dc
DEF DUELVARS_BENCH3_CARD_ATTACHED_CRYSTAL_SHARD    EQUS "LOW(wPlayerBench3CardAttachedDefender)"  ; dd
DEF DUELVARS_BENCH4_CARD_ATTACHED_CRYSTAL_SHARD    EQUS "LOW(wPlayerBench4CardAttachedDefender)"  ; de
DEF DUELVARS_BENCH5_CARD_ATTACHED_CRYSTAL_SHARD    EQUS "LOW(wPlayerBench5CardAttachedDefender)"  ; df
DEF DUELVARS_ARENA_CARD_ATTACHED_STRENGTH_CHARM    EQUS "LOW(wPlayerArenaCardAttachedPluspower)"  ; e0
DEF DUELVARS_BENCH1_CARD_ATTACHED_STRENGTH_CHARM   EQUS "LOW(wPlayerBench1CardAttachedPluspower)" ; e1
DEF DUELVARS_BENCH2_CARD_ATTACHED_STRENGTH_CHARM   EQUS "LOW(wPlayerBench2CardAttachedPluspower)" ; e2
DEF DUELVARS_BENCH3_CARD_ATTACHED_STRENGTH_CHARM   EQUS "LOW(wPlayerBench3CardAttachedPluspower)" ; e3
DEF DUELVARS_BENCH4_CARD_ATTACHED_STRENGTH_CHARM   EQUS "LOW(wPlayerBench4CardAttachedPluspower)" ; e4
DEF DUELVARS_BENCH5_CARD_ATTACHED_STRENGTH_CHARM   EQUS "LOW(wPlayerBench5CardAttachedPluspower)" ; e5
...
DEF SUBSTATUS1_2XDAMAGE_TO_SELF EQU $11
...
DEF SUBSTATUS1_IMMUNITY     EQU $1f
...
DEF SUBSTATUS3_POKEPOWERS_DISABLED     EQU 2
...
DEF NO_SPECIAL_CONDITIONS	     EQU $06
...
; constants for PracticeDuelActionTable entries
	...
	const PRACTICEDUEL_PLAY_MANTINE
	const PRACTICEDUEL_PUT_SEADRA_IN_BENCH
	...
	const PRACTICEDUEL_PLAY_SEADRA_FROM_BENCH
...
DEF SEARCHEFFECT_EEVEELUTION    EQU $5
