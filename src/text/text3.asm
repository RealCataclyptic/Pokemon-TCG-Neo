...
JungleDescriptionText: ; 3cca9 (f:4ca9)
	...
	line "We got fun and games..."
	done

FlowerGardenDescriptionText: ; 3ccea (f:4cea)
	text "Come to the flower garden;"
...
FireChargeDescriptionText: ; 3d0bb (f:50bb)
	text "Attack and heal at the same "
	line "time to conquer your foe!"
	done
...
LegendaryMoltresDescriptionText: ; 3d22a (f:522a)
	text "Use Prehistoric Power and"
	line "attack with basics!"
	done
...
Text0403: ; 3fe10 (f:7e10)
	...
	line "for striking with basic Pokémon,"
	line "backed up by Aerodactyl's power"
	line "to prevent evolved Pokémon from"
	line "entering play!"
