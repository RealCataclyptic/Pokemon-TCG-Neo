...
ReceivesDamageDueToStrikesBackText:
	...
	line "due to the effects of Magma Armor."
	done
...
ChooseNidoranFromDeckText:
	text "Choose an Unown card"
	line "from the Deck."
	done

ChooseNidoranText:
	text "Choose an Unown A"
	line "or an Unown J."
	done
...
ProcedureForEnergyTransferText:
	...
	line ""
	line "1. Choose the Pokémon to move <LIGHTNING>"
