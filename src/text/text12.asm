...
SelfDoubleDamageDesc:
	...
	line "all damage done to Charizard is"
	line "doubled. (After applying weakness"
	line "and resistance)"
	done
...
PresentDesc: 
	...
	line "heads, this attack does 80 damage."
...
PainSplitDesc:
	...
	line "Pokémon equal to half its remaining"
	line "HP (rounded up to the nearest 10)."
	line "Then, remove 1 damage counter from"
	line "Misdreavus (If any)."
	done
...
Do20MorePerOppEnergyDesc:
	text "Does 20 more damage for each energy"
	line "card attached to the defending"
	line "Pokémon."
	done
...
CFHPlus10AndConfuseDesc: 
	...
	line "defending Pokémon becomes Confused."
	done
