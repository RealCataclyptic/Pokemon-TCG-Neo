...
VenonatLeechLifeEffectCommands:
	dbw EFFECTCMDTYPE_AFTER_DAMAGE, ImposterProfessorOakEffect
	db  $00
...
NidoranFCallForFamilyEffectCommands:
	...
	dbw EFFECTCMDTYPE_BEFORE_DAMAGE, NidoranFCallForFamily_PlayerSelectEffect
	dbw EFFECTCMDTYPE_REQUIRE_SELECTION, NidoranFCallForFamily_AISelectEffect
	db  $00
