...
; The Effect Commands section has added notes for what each of the effects do. I have not modified many Effect Function names, but there are some notes there.
...
HeracrossCard: ; 31503 (c:5503)
	...
	dw NONE ; description (cont)
	db 0 ; damage
	db POKEMON_POWER ; Pokepower is just flavor. All its effects are in Megahorn.
	dw FinalBlowEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 40 ; damage
	db DAMAGE_NORMAL ; category
	dw FinalBlowActualEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
CrobatSCard: ; 33f63 (c:7f63)
	...
	; attack 1
	energy GRASS, 1 ; energies
	tx CriticalStrikeName ; name
	tx CriticalStrikeDesc ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_PLUS ; category
	...
	; attack 2
	energy GRASS, 2, FIRE, 1 ; energies
	tx CrossAttackName ; name
	tx CrossAttackDesc ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_X ; category
...
MagcargoCard: ; 317ce (c:57ce)
	...
	; attack 1
	energy 0 ; energies
	tx MagmaArmorName ; name
	tx MagmaArmorDesc ; description
	tx MagmaArmorDescCont ; description (cont)
	db 0 ; damage
	db POKEMON_POWER ; category
	dw MagmaArmorEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	; attack 2
	energy FIRE, 2, COLORLESS, 1 ; energies
	tx LavaStreamName ; name
	tx LavaStreamDesc ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_PLUS ; category
...
NinetalesCard:
	...
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw EtherealFlameEffectCommands ; effect commands
	db INFLICT_CONFUSION ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
FlareonCard: ; 31a17 (c:5a17)
	...
	tx MayRecoilForMoreDamageDesc ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_PLUS ; category
	dw CanDo30ButRecoilEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 3
	db ATK_ANIM_FLARE_BLITZ ; animation
...
BlastoiseCard:
	...
	tx NoLimitExtraWDamageDesc ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_PLUS ; category
	dw NoLimitExtraWEffectCommands ; effect commands
	db NONE ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
...
OmastarCard: ; 31b5c (c:5b5c)
	...
	; attack 2
	energy WATER, 1, COLORLESS, 2 ; energies
	tx AbyssalAmbushName ; name
	tx MoreDamageIfDFPInjuredDesc ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_PLUS ; category
...
ArticunoCard:
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw ETBCFPRZEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
KingdraSCard: ; 33fb7 (c:7fb7)
	...
	; attack 2
	energy WATER, 2, PSYCHIC, 2 ; energies
	tx DracoMeteorName ; name
	tx DracoMeteorDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db DAMAGE_NORMAL ; category
	...
	db NONE ; flags 3
	db 0
	db NONE ; animation ; This animation is found elsewhere.
...
Lanturn1Card: ; 323bd (c:63bd)
	...
	db 0 ; damage
	db POKEMON_POWER ; category
	dw RainDanceEffectCommands ; effect commands ; does nothing, real effect commands are in floodlight
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
	...
	db 20 ; damage
	db DAMAGE_NORMAL ; category
	dw FloodlightEffectCommands ; effect commands
	db INFLICT_PARALYSIS ; flags 1
	db ATTACHED_ENERGY_BOOST ; flags 2
	db NONE ; flags 3
	db MAX_ENERGY_BOOST_IS_NOT_LIMITED
...
RaichuCard: ; 324c1 (c:64c1)
	...
	tx LightningStrikeName ; name
	tx LightningStrikeDesc ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_NORMAL ; category
	dw DiscardAllLForPlusDamageEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
Raichu2Card:
	...
	tx MorePARIfHPLowDesc; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_PLUS ; category
...
ZapdosCard:
	...
	tx CF20ToABenchDesc ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw CF20ToABenchEffectCommands ; effect commands
	db DAMAGE_TO_OPPONENT_BENCH ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 20
...
GligarCard: ; 3284f (c:684f)
	...
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw MayPRZandPSNEffectCommands ; effect commands
...
MachopCard:
	...
	energy FIGHTING, 1, COLORLESS, 1 ; energies
	tx LowKickName ; name
	tx Do10PerOppRCDesc ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_X ; category
	dw Do10PerOppRCEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
MachokeCard:
	...
	; attack 2
	energy FIGHTING, 2, COLORLESS, 1 ; energies
	tx VitalThrowName ; name
	tx VitalThrowDesc ; description
	dw NONE ; description (cont)
	db 50 ; damage
	db DAMAGE_MINUS ; category
...
MachampCard:
	...
	tx Do10MorePerInjuredPokesDesc ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_PLUS ; category
...
RhydonCard:
	...
	tx CanOnlyUseOnceDesc ; description
	dw NONE ; description (cont)
	db 100 ; damage
	db DAMAGE_NORMAL ; category
	dw CanOnlyUseAttackOnceEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
KabutopsSCard: ; 32ce1 (c:6ce1)
	...
	; attack 2
	energy FIGHTING, 2, GRASS, 1 ; energies
...
HaunterCard: ; 32de5 (c:6de5)
	...
	energy PSYCHIC, 1 ; energies
	tx HexName ; name
	tx MoreDamageifDFPStatusedDesc ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_PLUS ; category
	dw Do20moreIfDFPStatusedEffectCommands ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_6 ; flags 2
	db NONE ; flags 3
	db 2
...
MewCard: ; 32ea8 (c:6ea8)
	...
	tx Do10PerEnergyAnyTargetDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db DAMAGE_NORMAL ; category
...
Espeon2Card: ; 32fac (c:6fac)
	...
	; attack 2
	energy PSYCHIC, 2, COLORLESS, 1 ; energies
	tx PsysplashName ; name
	tx PsysplashDesc ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_X ; category
	dw PsysplashEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 0
...
UmbreonCard: ; 32fed (c:6fed)
	...
	tx Do40AnyTargetDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db DAMAGE_NORMAL ; category
...
KadabraCard:
	...
	db NONE ; flags 3
	db 0
	db ATK_ANIM_SPECIAL_PSY ; animation
...
UnownJCard: ; 331b4 (c:71b4)
	...
	tx SearchFossilEggEffectCommandswnDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw SearchFossilEggEffectCommandswnEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING ; flags 3
	db 0
...
CelebiCard: ; 332f9 (c:72f9)
	...
	; attack 1
	energy PSYCHIC, 1 ; energies
	tx TimeLoopName ; name
	tx TimeLoopDescription ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw TimeLoopEffectCommands ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_6 ; flags 2
	db NONE ; flags 3
	db 0
...
NoctowlCard: ; 33501 (c:7501)
	...
	; attack 1
	energy COLORLESS, 2 ; energies
	tx TalonClutchName ; name
	tx MaySwitchAndNoRetreatDesc ; description
	dw NONE ; description (cont)
	db 10 ; damage
	db DAMAGE_NORMAL ; category
	dw SwitchAndNoRetreatEffectCommands ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_6 | SWITCH_OPPONENT_POKEMON ; flags 2
	db NONE ; flags 3
	db 1
	db ATK_ANIM_QUICK_ATTACK ; animation
...
EeveeCard: ; 3380d (c:780d)
	...
	tx RapidEvolutionDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw EeveelutionEffectCommands ; effect commands
	db NONE ; flags 1
	db NONE ; flags 2
	db SPECIAL_AI_HANDLING ; flags 3
	db 0
...
DelibirdCard: ; 33993 (c:7993)
	...
	tx PresentDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db RESIDUAL ; category
	dw SurprisePresentEffectCommands ; effect commands
	db NONE ; flags 1
	db FLAG_2_BIT_6 ; flags 2
	db NONE ; flags 3
	db 2
...
NoctowlSCard: ; 33c1d (c:7c1d)
	...
	tx MayPARorCFNDesc ; description
	dw NONE ; description (cont)
	db 30 ; damage
	db DAMAGE_NORMAL ; category
	dw MayParalyzeOrConfuseEffectCommands ; effect commands
	db INFLICT_PARALYSIS | INFLICT_CONFUSION ; flags 1
	db NONE ; flags 2
	db NONE ; flags 3
	db 2
	db ATK_ANIM_PSYCHIC_HIT ; animation
...
CharizardCCard: ; 33c9f (c:7c9f)
	...
	tx Discard2FDo10MorePerSelfDamageDesc ; description
	dw NONE ; description (cont)
	db 20 ; damage
	db DAMAGE_PLUS ; category
...
LugiaCCard: ; 33ce0 (c:7ce0)
	...
	; attack 2
	energy LIGHTNING, 1, WATER, 2 ; energies
...
HoohCCard: ; 33d21 (c:7d21)
	...
	; attack 2
	energy FIRE, 2, LIGHTNING, 1 ; energies
	tx PhoenixFlameName ; name
	tx PhoenixFlameDesc ; description
	dw NONE ; description (cont)
	db 40 ; damage
	db DAMAGE_PLUS ; category
...
ShadowLugiaCard: ; 33e4b (c:7e4b)
	...
	tx DarkDescentDesc ; description
	dw NONE ; description (cont)
	db 0 ; damage
	db POKEMON_POWER ; category
